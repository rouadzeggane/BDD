...
COMMENT ON TABLE ARTICLES_DW2 IS 'LA TABLES DES ARTICLES DES MAGASINS';
COMMENT ON COLUMN ARTICLES_DW2.NUMART IS 'LE NUMERO DE LARTICLE  ';
COMMENT ON COLUMN ARTICLES_DW2.NOMART IS 'NOM DE LARTICLE';
COMMENT ON COLUMN ARTICLES_DW2.PUART IS 'PRIX UNITAIRE ARTICLE ';

CREATE INDEX PK_ARTICLES_DW2 ON ARTICLES_DW2(NUMART);
CREATE INDEX IDX_ARTICLES_DW2 ON ARTICLES_DW2(NOMART);
CREATE INDEX IDX_ARTICLES_DW2 ON ARTICLES_DW2(PUART);
...
COMMENT ON TABLE MAGASINS_DW2 IS 'LA TABLES DES MAGASINS';
COMMENT ON COLUMN MAGASINS_DW2.NUMMAG IS 'LE NUMERO DU MAGASIN  ';
COMMENT ON COLUMN MAGASINS_DW2.NOMMAG IS 'NOM DU MAGASIN';
COMMENT ON COLUMN MAGASINS_DW2.TELMAG IS 'LE NUMERO DE TELEPHONE DU MAGASIN ';
COMMENT ON COLUMN MAGASINS_DW2.ADRNUMMAG IS 'LE NUMERO DE LIMMEUBLE DU MAGASIN';
COMMENT ON COLUMN MAGASINS_DW2.ADRRUEMAG IS 'LADRESSE RUE DU MAGASIN';
COMMENT ON COLUMN MAGASINS_DW2.ADRCPMAG IS 'LE CODE POSTAL DU MAGASIN';
COMMENT ON COLUMN MAGASINS_DW2.ADRVILLEMAG IS 'LA VILLE DU MAGASIN ';
COMMENT ON COLUMN MAGASINS_DW2.ADRPAYSMAG IS 'LE PAYES DU MAGASIN ';

CREATE INDEX PK_MAGASINS_DW2 ON MAGASINS_DW2(NUMMAG);
CREATE INDEX IDX_MAGASINS_DW2 ON MAGASINS_DW2(NOMMAG);
CREATE UNIQUE INDEX UX_MAGASINS_DW2 ON MAGASINS_DW2(TELMAG);
...
COMMENT ON TABLE TEMPS_DW2 IS 'LA TABLES QUI SURVEILLE LE TEMPS';
COMMENT ON COLUMN TEMPS_DW2.IDTEMPS IS 'LIDENTIFIANT DU TEMPS';
COMMENT ON COLUMN TEMPS_DW2.DATEHEURET IS 'LHEURE';
COMMENT ON COLUMN TEMPS_DW2.ANNEET IS 'ANNEE ';
COMMENT ON COLUMN TEMPS_DW2.MOIST IS 'LE MOIS ';
COMMENT ON COLUMN TEMPS_DW2.JOURT IS 'LE JOUR ';

CREATE INDEX PK_TEMPS_DW2 ON TEMPS_DW2(IDTEMPS);
...
NOCACHE
NOPARALLEL ;
COMMENT ON TABLE CLIENTS_DW2 IS 'LA TABLES DU CLIENT';
COMMENT ON COLUMN CLIENTS_DW2.NUMCLI IS 'LIDENTIFIANT DU CLIENT';
COMMENT ON COLUMN CLIENTS_DW2.NOMCLI IS 'LE NOM DU CLIENT';
COMMENT ON COLUMN CLIENTS_DW2.TELCLI IS 'LE TELEPHONE DU CLIENT';
COMMENT ON COLUMN CLIENTS_DW2.ADRNUMCLI IS 'LE NUMERO DE LIMMEUBLE DU CLIENT ';
COMMENT ON COLUMN CLIENTS_DW2.ADRRUECLI IS 'LADRESSE RUE DU CLIENT';
COMMENT ON COLUMN CLIENTS_DW2.ADRCPCLI IS 'LE CODE POSTAL DU CLIENT';
COMMENT ON COLUMN CLIENTS_DW2.ADRVILLECLI IS 'LA VILLE DU CLIENT ';
COMMENT ON COLUMN CLIENTS_DW2.ADRPAYSCLI IS 'LE PAYES DU CLIENT ';


CREATE INDEX PK_CLIENTS_DW2 ON CLIENTS_DW2(NUMMAG);
CREATE INDEX IDX_CLIENTS_DW2 ON CLIENTS_DW2(NOMMAG);
CREATE UNIQUE INDEX UX_CLIENTS_DW2 ON CLIENTS_DW2(TELCLI);
...
( 
	...
	CONSTRAINT FK_VENTES_DW2_NUMART_ARTICLES2 FOREIGN KEY(NUMART) REFERENCES ARTICLES_DW2(NUMART),
	CONSTRAINT FK_VENTES_DW2_NUMMAG_MAGASINS FOREIGN KEY(NUMMAG) REFERENCES MAGASINS_DW2(NUMMAG),
	CONSTRAINT FK_VENTES_DW2_IDTEMPS_TEMPS2 FOREIGN KEY(IDTEMPS) REFERENCES TEMPS_DW2(IDTEMPS),
	CONSTRAINT FK_VENTES_DW2_NUMCLI_CLIENTS2 FOREIGN KEY(NUMCLI) REFERENCES CLIENTS_DW2 (NUMCLI)	
)
TABLESPACE USERS STORAGE ( INITIAL 50K)
PARTITION BY LIST (PAYS)
(PARTITION PT_VENTE_DE  VALUES ('DE')TABLESPACE USERS,
PARTITION PT_VENTE_ES VALUES ('ES')TABLESPACE USERS,
PARTITION PT_VENTE_IT VALUES ('IT')TABLESPACE USERS,
PARTITION PT_VENTE_GB VALUES ('GB')TABLESPACE USERS,
PARTITION PT_VENTE_KR VALUES ('KR')TABLESPACE USERS,
PARTITION PT_VENTE_FR VALUES ('FR')TABLESPACE USERS,
PARTITION PT_VENTE_DEF VALUES (DEFAULT)TABLESPACE USERS
);

COMMENT ON TABLE VENTES_DW2 IS 'LA TABLES CENTRALE LA VENTE ';
COMMENT ON COLUMN VENTES_DW2.NUMVENTE IS 'LE NUMERO DE LA VENTE';
COMMENT ON COLUMN VENTES_DW2.NUMART IS 'LE NUMERO DE LARTICLE';
COMMENT ON COLUMN VENTES_DW2.IDTEMPS IS 'LE TEMPS DE LA VENTE ';
COMMENT ON COLUMN VENTES_DW2.NUMCLI IS 'LE NUMERO DU CLIENT ';
COMMENT ON COLUMN VENTES_DW2.MONTANTVENTE IS 'LE MONTANT DE LA VENTE ';
COMMENT ON COLUMN VENTES_DW2.NUMMAG IS 'LE NUMERO DU MAGASN OU LA VENTE A ETE PASSEE';
COMMENT ON COLUMN VENTES_DW2.PAYS IS 'LE PAYES DE LA VENTE';


CREATE INDEX PK_VENTES_DW2 ON CLIENTS_DW2(NUMVENTE);
CREATE INDEX IDX_VENTES_DW2 ON CLIENTS_DW2(PAYS);
CREATE UNIQUE INDEX UX_VENTES_DW2 ON CLIENTS_DW2(NUMART,IDTEMPS,NUMCLI,NUMMAG);
...
INSERT INTO MAGASINS_DW2 (NUMMAG, NOMMAG, TELMAG, ADRNUMMAG, ADRRUEMAG, ADRCPMAG, ADRVILLEMAG, ADRPAYSMAG)
VALUES ('FR03', 'BB-SAY THANK YOU','0254974410', '77', 'RUE DE LA LIBERTE', '13001', 'MARSEILLE', 'FRANCE');
...
-- Donnez les vues du catalogue Oracle pour consulter la description de la table « VENTE » et de ses indexeS  
select * from dict where TABLE_NAME = '%USERS%';

select view_name from sys.all_views where owner like 'AHCENE94';

--select OWNER,TABLE_NAME,NUM_ROWS from DBA_TABLES where OWNER like upper('ahcene94');
select * from DBA_TABLES where TABLE_NAME = 'VENTES_DW2';
...
TTITLE CENTER 'Vue1: Total des ventes des MAGASINS_DW2 a partir de 2002, par ville et annee' skip 1 -
       LEFT   '=========================================================================' skip 0
...
TTITLE CENTER 'Vue2: Total des ventes des MAGASINS_DW2 en France par ville, annee et mois' skip 1 -
       LEFT   '=========================================================================' skip 0
...
TTITLE CENTER 'Vue3: Total des ventes des MAGASINS_DW2 en Belgique ,avant <= 2001,' skip 1 -
...
select *
 ...
 where table_owner = USERS
   and table_name = VENTES_DW2;
